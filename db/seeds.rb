...
project2 = Project.create(name: "React application for review", details: "React is a JavaScript library for building user interfaces. It is maintained by Facebook and a community of individual developers and companies. React can be used as a base in the development of single-page or mobile applications." , done: false , user_id: user1.id)
...
project6 = Project.create(name: "A Craigslist website", details: "Craiglist website helps with jobs, housing, for sale, items wanted, services, community service, gigs, résumés, and discussion forums." , done: false , user_id: user1.id)
